...
public static class OrderTexts
{
    ...
    private static readonly Dictionary<string, (string En, string Es)> Strings = new()
    {
        ...
        ["err.conjuring-target-must-be-of-a-different-nation"] = ("Conjuring target must be of a different nation", "El objetivo debe ser de otra nación"),
        ["err.conjuring-target-must-be-in-the-same-hex-t"] = ("Conjuring target must be in the same hex ({0})", "El objetivo debe estar en el mismo hex ({0})"),
        ["err.conjuring-target-must-be-in-same-or-adjacent-hex-t"] = ("Conjuring target must be in same or adjacent hex ({0})", "El objetivo debe estar en hex adyacente o mismo ({0})"),
        ["err.conjuring-mounts-must-be-at-own-population-centre"] = ("Conjure Mounts requires you to be at a population centre of your own nation", "Invocar monturas requiere estar en un centro propio"),
        ["err.conjuring-food-must-be-at-own-pc-or-with-army-navy"] = ("Conjure Food requires you to be at own PC or with an army/navy", "Invocar comida requiere estar en centro propio o con ejército/armada"),
        ["err.conjuring-hordes-must-be-with-army-or-navy"] = ("Conjure Hordes requires you to be with an army or navy", "Invocar hordas requiere estar con ejército o armada"),
        ["err.conjuring-hordes-dark-servants-only"] = ("Conjure Hordes is only available to Dark Servants", "Invocar hordas solo para Sirvientes Oscuros"),
        ...
        ["label.amount-empty-0-max"] = ("Amount (0 = maximum)", "Cantidad (0 = máximo)"),
        ...
        ["label.target-character-other-nation-same-hex"] = ("Target character (other nation, same hex)", "Personaje de otra nación (mismo hex)"),
